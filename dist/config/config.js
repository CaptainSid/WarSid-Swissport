...
var envVarsSchema = _joi2.default.object({
  ...
  JWT_SECRET: _joi2.default.string().default('lfjqljfnfnnffuenqjfnlqnlqnfmfqmfmqfmf').description('JWT Secret required to sign'),
  MONGO_HOST: _joi2.default.string().default('localhost').description('Mongo DB host url'),
